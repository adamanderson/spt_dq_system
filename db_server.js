...
function updateWinterMapPlots() {
    args = ['-B',
            ...
            config.coadds_data_dirs.winter,
            config.coadds_figs_dirs.winter,
            config.coadds_logs_dirs.winter,
            config.calib_data_dir,
            config.bolo_data_dir,
...
function updateSummerMapPlots() {
    args = ['-B',
            ...
            'summer',
            config.maps_data_dir,
            config.coadds_data_dirs.summer,
            config.coadds_figs_dirs.summer,
            config.coadds_logs_dirs.summer,
            config.calib_data_dir,
            config.bolo_data_dir,
            config.min_time_maps]
...
function updateSummerbMapPlots() {
    args = ['-B',
            ...
            'summerb',
            config.maps_data_dir,
            config.coadds_data_dirs.summerb,
            config.coadds_figs_dirs.summerb,
            config.coadds_logs_dirs.summerb,
            config.calib_data_dir,
            config.bolo_data_dir,
            config.min_time_maps]
...
if(config.site == 'pole') { // only update map and arc plots at pole
    setInterval(updateWinterMapPlots,   7200000);
    setInterval(updateSummerMapPlots,   7200000);
    setInterval(updateSummerbMapPlots,  7200000);
    setInterval(updateSummercMapPlots,  7200000);
